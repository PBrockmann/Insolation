...
#
#   generates the figures of the paper "On the computation of several « insolation »
#           quantities relevant to climatology or planetology"
#   by Didier Paillard, LSCE
#
...
print('The requested figures need to be selected (True/False) in the first lines of the code')
print('')
...
plot_figure_8 = False
plot_figure_9 = False
plot_figure_A1 = False
plot_figure_A2 = False
plot_figure_A3 = False
plot_figure_A4 = False
plot_figure_A5 = False
plot_figure_A6 = False
plot_figure_A7 = False
plot_figure_A8 = False
plot_figure_A9 = False
plot_figure_A10 = False
...
if plot_figure_A3:          # solHofU(c,h)  +  e2L(c,u)
...
#############   mid-points vs averaged daily insolation, on a low-resolution grid
